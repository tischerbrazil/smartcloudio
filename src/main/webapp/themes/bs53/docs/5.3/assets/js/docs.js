 ...
 */ !(function (e, t) {
        ...
        (n = {
            686: function (e, t, n) {
                ...
                function f(e, t) {
                    var n,
                        ...
                        e =
                            ...
                            (e.value = s),
                            e);
                    return t.container.appendChild(e), (t = a()(e)), r("copy"), e.remove(), t;
                }
                s = function (e) {
                    var n =
                ...
                d = function () {
                    ...
                    return t ? s(t, { container: o }) : e ? ("cut" === n ? c(e) : s(e, { container: o })) : void 0;
                };
                function o(e) {
                    return (o =
                        "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
                ...
                function v(e) {
                    ...
                    return function () {
                        ...
                        return (
                            (n = t
                                ? ((n = l(this).constructor), Reflect.construct(s, arguments, n))
                                : s.apply(this, arguments)),
                            (s = this),
                            !(n = n) || ("object" !== o(n) && "function" != typeof n)
                                ? (function (e) {
                    ...
                    return (
                        ...
                        (a = [
                            ...
                            },
                            {
                                key: "defaultTarget",
                                value: function (e) {
                                    if (((e = i("target", e)), e)) return document.querySelector(e);
                                },
                            },
                            {
                                key: "defaultText",
            ...
            438: function (e, t, n) {
                ...
                function s(e, t, n, s, i) {
                    var a = function (e, t, n, s) {
                        return function (n) {
                            (n.delegateTarget = o(n.target, t)), n.delegateTarget && s.call(e, n);
                        };
            ...
            370: function (e, t, n) {
                ...
                e.exports = function (e, t, n) {
                    ...
                    if (s.string(e)) return (e = e), (t = t), (n = n), o(document.body, e, t, n);
                        ...
                        t =
                            "SELECT" === e.nodeName
                                ...
                                : "INPUT" === e.nodeName || "TEXTAREA" === e.nodeName
                                  ? ((n = e.hasAttribute("readonly")) || e.setAttribute("readonly", ""),
                                    e.select(),
                ...
                (t.prototype = {
                    ...
                    off: function (e, t) {
                        var n,
                            ...
                            i = [];
                        if (s && t)
                            for (n = 0, a = s.length; n < a; n++) s[n].fn !== t && s[n].fn._ !== t && i.push(s[n]);
    ...
    (() => {
        ...
        if (e) {
            const n = e.clientHeight,
                s = document.querySelector(".bd-links-nav .active"),
                i = s.offsetTop,
                o = s.clientHeight,
                t = i,
                a = t - n + o;
            (e.scrollTop > t || e.scrollTop < a) && (e.scrollTop = t - n / 2 + o / 2);
        }
    })(),
    (() => {
        "use strict";
        ...
        document.querySelectorAll(".highlight").forEach((e) => {
            e.closest(".bd-example-snippet") ||
                (e.insertAdjacentHTML("beforebegin", o), e.previousElementSibling.append(e));
        });
        function t(e, t) {
            document.querySelectorAll(e).forEach((e) => {
                bootstrap.Tooltip.getOrCreateInstance(e, { title: t });
            });
        }
        t(".btn-clipboard", e), t(".btn-edit", s);
        ...
        n.on("success", (t) => {
            ...
            o.setContent({ ".tooltip-inner": "Copied!" }),
                t.trigger.addEventListener(
                    "hidden.bs.tooltip",
                    () => {
                        o.setContent({ ".tooltip-inner": e });
                    },
                    { once: !0 }
                ),
                t.clearSelection(),
    ...
    (() => {
        ...
        window.docsearch({
            ...
            appId: "AK7KMZKZHQ",
            container: e,
            searchParameters: { facetFilters: [`version:${t}`] },
            transformItems(e) {
                return e.map((e) => {
                    const t = "https://getbootstrap.com/";
                    return (
                        (e.url = window.location.origin.startsWith(t) ? e.url : e.url.replace(t, "/")),
                        e.anchor === "content" && ((e.url = e.url.replace(/#content$/, "")), (e.anchor = null)),
                        e
                    );
                });
            },
    ...
    (() => {
        ...
        e &&
            ...
            document.querySelectorAll(".bd-example .toast").forEach((e) => {
                const t = new bootstrap.Toast(e, { autohide: !1 });
                t.show();
            });
