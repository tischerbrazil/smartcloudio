...
@JsonTypeName("RDivBreak")
public class RDivBreak extends RUIComponentBase {

	public static final String COMPONENT_TYPE = "RDivBreak";
	public static final String COMPONENT_FAMILY = "org.risteos.component";
	public static final String DEFAULT_RENDERER = "/includes/widgets/RDivBreak.xhtml";
