...
@Entity
@DiscriminatorValue("wmsgeoserver")
public class LayerWMSGeoserver extends LayerGeoserver {

	private static final long serialVersionUID = 1L;
	
	public LayerWMSGeoserver() {
	}

	public LayerWMSGeoserver(String name, ApplicationEntity applicationEntity, int lastOrder) {
		
		this.setStrings(JacksonUtil.toJsonNode("{}"));
		this.setEpsg(applicationEntity.getEpsg());
		this.setDescription("");
		this.setDtype("wmsgeoserver");
		this.setName(name);
		this.setTitle(name);
