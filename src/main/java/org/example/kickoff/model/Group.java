...
import static org.example.kickoff.model.Role.EDIT_ADMINISTRATOR_PAGES;
import static org.example.kickoff.model.Role.EDIT_ERP_PAGES;
import static org.example.kickoff.model.Role.EDIT_SCM_PAGES;
import static org.example.kickoff.model.Role.EDIT_CRM_PAGES;
import static org.example.kickoff.model.Role.EDIT_SECURITY_PAGES;
import static org.example.kickoff.model.Role.EDIT_GIS_PAGES;
...
public enum Group {
	...
	ADMINISTRATOR(EDIT_ADMINISTRATOR_PAGES),
	ERP(EDIT_ERP_PAGES),
	
	SCM(EDIT_SCM_PAGES),
	CRM(EDIT_CRM_PAGES),
	SECURITY(EDIT_SECURITY_PAGES),
	GIS(EDIT_GIS_PAGES, ACCESS_API),
