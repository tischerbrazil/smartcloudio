...
public class LoginToken extends GeneratedIdEntity {
	...
	@Column(name="token_hash" , length = HASH_LENGTH, nullable = false, unique = true)
	...
	@Column(name="ip_address", length = IP_ADDRESS_MAXLENGTH, nullable = false)
