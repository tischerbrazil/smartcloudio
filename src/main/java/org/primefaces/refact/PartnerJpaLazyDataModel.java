...
public class PartnerJpaLazyDataModel<T> extends LazyDataModel<T> implements Serializable {
	 ...
	 */
	public PartnerJpaLazyDataModel() {
	 ...
	 */
	public PartnerJpaLazyDataModel(Class<T> entityClass, SerializableSupplier<EntityManager> entityManager) {
