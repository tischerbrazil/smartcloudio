...
public class ApplicationJpaLazyDataModel<T> extends LazyDataModel<T> implements Serializable {
	 ...
	 */
	public ApplicationJpaLazyDataModel() {
	 ...
	 */
	public ApplicationJpaLazyDataModel(Class<T> entityClass, SerializableSupplier<EntityManager> entityManager) {
