...
public class ProductAllJpaLazyDataModel<T> extends LazyDataModel<T> implements Serializable {
	 ...
	 */
	public ProductAllJpaLazyDataModel() {
	 ...
	 */
	public ProductAllJpaLazyDataModel(Class<T> entityClass, SerializableSupplier<EntityManager> entityManager) {
		this.entityClass = entityClass;
		this.entityManager = entityManager;
	}
	
	public ProductAllJpaLazyDataModel(Class<T> entityClass, SerializableSupplier<EntityManager> entityManager,
			Map<String, FilterMeta> filterByParam) {
			...
			for (FilterMeta filter : filterBy.values()) {
				...
				if (filter.isGlobalFilter()) {
					 ...
					 Predicate predicateB
					  = cb.like(cb.lower(root.<String>get("introduction")), '%' + filter.getFilterValue().toString().toLowerCase() + '%');
					 
					 Predicate finalPredicate
					  = cb
					  .or(predicateA, predicateB);
