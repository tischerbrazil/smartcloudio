...
public class RealmJpaLazyDataModel<T> extends LazyDataModel<T> implements Serializable {
	 ...
	 */
	public RealmJpaLazyDataModel(Class<T> entityClass, SerializableSupplier<EntityManager> entityManager) {
