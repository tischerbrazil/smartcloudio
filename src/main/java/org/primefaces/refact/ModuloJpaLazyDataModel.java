...
public class ModuloJpaLazyDataModel<T> extends LazyDataModel<T> implements Serializable {
	 ...
	 */
	public ModuloJpaLazyDataModel(Class<T> entityClass, SerializableSupplier<EntityManager> entityManager) {
