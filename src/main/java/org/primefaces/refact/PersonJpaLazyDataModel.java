...
public class PersonJpaLazyDataModel<T> extends LazyDataModel<T> implements Serializable {
	 ...
	 */
	public PersonJpaLazyDataModel(Class<T> entityClass, SerializableSupplier<EntityManager> entityManager) {
