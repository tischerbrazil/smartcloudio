...
public class ShoppingCartJpaLazyDataModel<T> extends LazyDataModel<T> implements Serializable {
	 ...
	 */
	public ShoppingCartJpaLazyDataModel() {
	 ...
	 */
	public ShoppingCartJpaLazyDataModel(Class<T> entityClass, SerializableSupplier<EntityManager> entityManager) {
	...
	protected void applyFilters(CriteriaBuilder cb, CriteriaQuery<?> cq, Root<T> root,
		...
		List<Predicate> predicates = new ArrayList<>();
		 ...
		 Predicate predicatePAYDOUT = cb.equal(root.get("status"), ShoppingCart.Status.PAIDOUT);
		 
		 predicates.add(predicatePAYDOUT);
