...
public class ClientJpaLazyDataModel<T> extends LazyDataModel<T> implements Serializable {
	 ...
	 */
	public ClientJpaLazyDataModel(Class<T> entityClass, SerializableSupplier<EntityManager> entityManager) {
