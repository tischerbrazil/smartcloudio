...
@Entity
@Table(name = "gateway_safrapay_api_token")
@NamedQueries({ @NamedQuery(name = "SafraPayApiToken.FIND", query = "SELECT s FROM SafraPayApiToken s where s.id = 1"),
})
public class SafraPayApiToken implements Serializable{

	public SafraPayApiToken() {
	}

	private static final long serialVersionUID = 1L;

	public static final String FIND = "SafraPayApiToken.FIND";
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SafraPayApiToken other = (SafraPayApiToken) obj;
